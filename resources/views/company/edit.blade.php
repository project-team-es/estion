<x-app-layout>
    <x-slot name="title">企業情報編集</x-slot>

    <div class="max-w-4xl mx-auto py-12 px-6">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">企業情報編集</h2>
        ...
        <div class="bg-white rounded-[12px] p-6 border">
            <form method="POST" action="{{ route('company.update', $company) }}">
                ...
                <div class="mb-4">
                    ...
                    <select name="industry_id" id="industry_id" class="w-full border-gray-300 rounded-[12px] focus:ring-blue-500 focus:border-blue-500 px-4 py-2">
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="homepage" id="homepage" value="{{ old('homepage', $company->homepage) }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="mypage" id="mypage" value="{{ old('mypage', $company->mypage) }}"
                           class="w-full border-gray-300 rounded-[12px] focus:ring-blue-500 focus:border-blue-500 px-4 py-2">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="loginid" id="loginid" value="{{ old('loginid', $company->loginid) }}"
                           class="w-full border-gray-300 rounded-[12px] focus:ring-blue-500 focus:border-blue-500 px-4 py-2">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="status" id="status" value="{{ old('status', $company->status) }}"
                           class="w-full border-gray-300 rounded-[12px] focus:ring-blue-500 focus:border-blue-500 px-4 py-2">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="process" id="process" value="{{ old('process', $company->process) }}"
                           class="w-full border-gray-300 rounded-[12px] focus:ring-blue-500 focus:border-blue-500 px-4 py-2">
                </div>
